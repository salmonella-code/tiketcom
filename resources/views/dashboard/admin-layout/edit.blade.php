...
<form method="POST" enctype="multipart/form-data" action="{{ route('AdminUser.update', $items->id) }}">
    @method('PUT')
    @csrf

    <div class="form-group">
        <label for="name">Nama</label>
        <input type="text" class="form-control" id="name" name="name" placeholder="Maskapai" value="{{ $items->name }}">
    </div>
    <div class="form-group">
        <label for="email">Email</label>
        <input type="text" class="form-control" id="email" name="email" placeholder="Maskapai" value="{{ $items->email }}">
    </div>
    <div class="form-group">
